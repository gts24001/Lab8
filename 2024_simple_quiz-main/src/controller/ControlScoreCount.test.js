...
describe('ControlScoreCount', () => {
  ...
  describe('updateScore', () => {
    test('should add points to current score', () => {
      ...
      expect(controller.getCurrentScore()).toBe(8);
    });

    test('should handle zero current score', () => {
      controller.updateScore(1);
      expect(controller.getCurrentScore()).toBe(1);
    });

    test('should handle adding zero points', () => {
      controller.score = 5;
      controller.updateScore(0);
      expect(controller.getCurrentScore()).toBe(5);
    });
  });
  ...
  describe('getCurrentScore', () => {
    ...
    test('should return 0 initially', () => {
      expect(controller.getCurrentScore()).toBe(0);
    });
  });
  ...
  describe('resetScore', () => {
    ...
    test('should reset from any value', () => {
  ...
  describe('submitAnswer', () => {
    ...
    test('should update internal score', () => {
      controller.submitAnswer('A', 'A');
      expect(controller.getCurrentScore()).toBe(1);
      
      controller.submitAnswer('B', 'B');
      expect(controller.getCurrentScore()).toBe(2);
    });
  });
});
